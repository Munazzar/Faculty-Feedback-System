...
echo $query="select c15 from t103_".$property_decode['current_database']['value']." where c25='$year'";
$subject="";
if($result=mysqli_query($con,$query))
		{
			...
			echo $subject=substr($subject,0,-1).',';
			echo "$file_name<br>";
		$tmpfname = "docs/student_details/MBA/$file_name";
