...
<h3>Check And Press Submit</h3>
<p>Please do not change any value unless if neccessary</p>
<table class='table table-hover'>
<form action='create_new_sem.php' method='POST'>
...
//logging
 $desc=":attempting to creating $last_database database";
 require_once('logging_sub_admin.php');

//showing the creating database value in text box for editing if needed
echo "
<tr><td><input type='text' value='$key_last' name='sno' class='form-control'></td><td><input type='text' value='$last_database' name='databaseid' class='form-control'></td><td><input type='text' value='$last_database_name' name='databasename' class='form-control'></td></tr>
...
$query="create table t106_$last_database(c16 varchar(20) primary key,c26 varchar(20) not null unique key)";
if(mysqli_query($con,$query))
{
	//echo "<br>database Created<br>";
	//echo $query;
...
//updating verification and passwords of all students of t101 table
...
//logging
 $desc="$last_database database cluster created successfully";
