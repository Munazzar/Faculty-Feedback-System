...
foreach($files_in_dir as $file)
{
	...
	if($file_details["extension"]=='xlsx')
	{
		...
		$pe_subject_name=$worksheet->getCell('B'.$row)->getValue();	
		$query="insert into t110_".$property_decode['current_database']['value']."(c1,c36)values('$student_id','$pe_subject_name')";	
		//echo "<br>";
