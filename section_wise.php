    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
				...
				<p>Note: section wise analysis for each semester only for Regular subjects</p>
                <?php
				...
				foreach($property_decode['database'] as $db_key=>$db_id)
				{
					...
					echo "<div style='margin-left:10px;margin-right:10px;margin-bottom:10px;background-color:white;border-radius:6px;padding:20px;overflow:auto;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);;border:black 1px;'> <h3>$year_name</h3><table class='table'>";
