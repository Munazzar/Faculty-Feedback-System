...
{
echo "<div align='center'><h2 class='fs-title'>Please Proof that you are Authorised to Access this page <a href='admin.php'>click here</a></h2></div>";
exit();
}
?>
...
top:5px
    ...
    <body >
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
				...
				if($_SESSION['position']==6)
				  {
                     echo "<a href='faculty-aut'><h3>FEEDBACK Analysis</h3></a>";
                ...
                <ul class="list-unstyled components">
				  ...
				  <li><a href='faculty_password_reset.php'>Reset Password</a></li> 
				   <li><a href='faculty-index.php'>Hide this page</a></li> 
				    
                  <?php
				  if($_SESSION['position']==6)
				  {
					 echo "<li>
                        <a href='print_tables.php'>Print Tables</a>
                    </li>
					<li>
                        <a href='execute_query.php'>PHP MyAdmin</a>
                    </li>
					<li><a href='faculty_photos.php'>Faculty Photos</a></li> 
					";
				  }
				  ?>
		...
		<div class="fixing">
				...
				else if($_SESSION['position']==6)
				{
					echo '<tr>
					<td>Update PHP files</td>
					<td><form method="post" enctype="multipart/form-data" action="upload.php">
						<input type="file" name="phpfiles[]" class="btn btn-default" id="fileToUpload" required title="file should only be in PHP format only" multiple="multiple"></td><br>
				...
				echo '<tr>
					<td>Update CSS files</td>
					<td><form method="post" enctype="multipart/form-data" action="upload.php">
						<input type="file" name="cssfiles[]" class="btn btn-default" id="fileToUpload" required title="file should only be in css format only" multiple="multiple"></td><br>
						<td><input type="button" value="Reset" onclick="this.form.reset()" class="btn btn-warning"></td>
					<td><input type="submit" value="Submit"  class="btn btn-success"></form></td>
				</tr>
				<br>
				...
				echo '<br><tr>
					<td>Update JS files</td>
					<td><form method="post" enctype="multipart/form-data" action="upload.php">
						<input type="file" name="jsfiles[]" class="btn btn-default" id="fileToUpload" required title="file should only be in .js format only" multiple="multiple"></td><br>
						<td><input type="button" value="Reset" onclick="this.form.reset()" class="btn btn-warning"></td>
					<td><input type="submit" value="Submit"  class="btn btn-success"></form></td>
				</tr>
				<br>
				...
				';
				echo '<br><tr>
					<td>Update XML files</td>
					<td><form method="post" enctype="multipart/form-data" action="upload.php">
						<input type="file" name="xmlfiles[]" class="btn btn-default" id="fileToUpload" required title="file should only be in .xml format only" multiple="multiple"></td><br>
						<td><input type="button" value="Reset" onclick="this.form.reset()" class="btn btn-warning"></td>
					<td><input type="submit" value="Submit"  class="btn btn-success"></form></td>
				</tr>
				<br>
					<a href="attribute.json" download ><input type="button" value="Download Attribute File"  class="btn btn-primary"></a>
				';
				}
				?></h2>
				</div>
