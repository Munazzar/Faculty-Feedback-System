...
$dir='./docs/subject_list/pe_subject_list/';
...
foreach($files_in_dir as $file)
{
	...
	if($file_details["extension"]=='xlsx')
	{
		...
		continue;
		$tmpfname = "docs/subject_list/pe_subject_list/$file_name";
		...
		$count++;
		$sub_id=$id.$count;
		echo $query="insert into t108_".$property_decode['current_database']['value']."(c38,c36)values('$sub_id','$oe_sub')";	
			//echo "<br>";
