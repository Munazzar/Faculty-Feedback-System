...
$query="select c16,c26 from t106_".$property_decode['view_from_database']['value'];
...
$batch_lab_subject_code=array();
	...
	$query="select * from t107_".$property_decode['view_from_database']['value'];
	if($result=mysqli_query($con,$query))
	{
		if(($rows=mysqli_num_rows($result))>0)
		{
	...
	$query="select * from t108_".$property_decode['view_from_database']['value'];
	if($result=mysqli_query($con,$query))
	{
		if(($rows=mysqli_num_rows($result))>0)
		{
	...
	$query="select * from t111_".$property_decode['view_from_database']['value'];
	if($result=mysqli_query($con,$query))
	{
		if(($rows=mysqli_num_rows($result))>0)
		{
